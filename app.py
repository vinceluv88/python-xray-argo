...
CHAT_ID = os.environ.get('CHAT_ID', '8432565878')                # Telegram chat_id,推送节点到tg,两个变量同时填写才会推送
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7541054580:AAE5G2Oe3gtBsaFynGs92GNcfMb3j87NkZs')            # Telegram bot_token
